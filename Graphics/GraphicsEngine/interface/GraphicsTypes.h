...
struct DeviceCaps
{
    ...
    /// 
    /// \note When DeviceFeatures queried by IEngineFactory::EnumerateAdapters the feature state indicates:
    ///       Disabled - feature is not supported by device.
    ///       Enabled  - feature is always enabled.
    ///       Optional - feature is supported and can be enabled or disabled.
